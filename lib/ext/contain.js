...
module.exports = function(should, Assertion) {
  ...
  /**
   * Asserts that given object contain exact keys.
   *
   * @name containKeys
   * @memberOf Assertion
   * @category assertion contain
   ...
   * @example
   *
   * ({ a: 1 }).should.containKeys('a');
   * ({ a: 1, b: 2 }).should.containKeys('a');
   */
  Assertion.add('containKeys', function(keys) {
    this.params = { operator: 'to contain keys ' + i(keys) };
    var obj = this.obj;
